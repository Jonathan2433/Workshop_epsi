...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 08 oct. 2021 à 08:01
...
INSERT INTO `resultat` (`id_resultat`, `id_utilisateur`, `id_question`, `id_reponse`, `date_resultat`) VALUES
(1, 13, 1, 1, NULL);
...
INSERT INTO `utilisateur` (`id_utilisateur`, `nom`, `prenom`, `mail`, `age`, `date_crea`, `date_edit`, `mdp`, `id_abilitation`, `id_metier`, `id_etablissement`) VALUES
(13, 'plop', 'plop', 'plop@plop.plop', 14, '2021-10-08 06:47:41', '0000-00-00 00:00:00', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 1, 2, 1);
...
--
ALTER TABLE `resultat`
  MODIFY `id_resultat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
